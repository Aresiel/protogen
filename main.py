...
class cmds:
    ...
    honk = "HONK"
    askprotopaw = "Ask Proto the almighty, and he shall give you an answer"
...
class syntax:
    ...
    info = "`?info`"
    honk = "`?honk`"
    askprotopaw = "`?askprotopaw <Question>`"
